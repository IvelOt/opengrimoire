...
const translations = {
  'pt-BR': {
    ...
    mp_title_ping_all: "Envia uma mensagem de teste para todos os jogadores na sala.",
    mp_btn_ping_host: "Ping Mestre",
    mp_title_ping_host: "Envia uma mensagem de teste apenas para o Mestre.",
    mp_btn_leave: "Sair",
    mp_name_ph: "Seu Nome",
  ...
  'en-US': {
    ...
    mp_btn_join: "Join",
    mp_btn_ping_all: "Broadcast",
    mp_title_ping_all: "Sends a test message to all players in the room.",
    mp_btn_ping_host: "Ping Host",
    mp_title_ping_host: "Sends a test message only to the Host.",
    mp_btn_leave: "Leave",
